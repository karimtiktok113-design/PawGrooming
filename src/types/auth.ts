 ...
 * 2. lastActiveAt is within the last 6 seconds (fresh 2-second heartbeat with 3-interval grace window)
 */
export function isClientProfileOnline(profile?: ClientProfile | null): boolean {
  ...
  // Consider online if heartbeat was active within the last 6 seconds
  return diffMs >= 0 && diffMs < 6000;
}
